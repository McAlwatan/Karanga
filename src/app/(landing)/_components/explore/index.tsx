...
export const ExploreSection = (props: Props) => {
  return (
    <div className="w-full pt-20 flex flex-col items-center gap-3" id="explore">
      <BackdropGradient className="w-8/12 h-full opacity-40 flex flex-col items-center">
        <GradientText
          className="text-4xl font-semibold text-center"
          element="H2"
        >
          Explore our most common fields
        </GradientText>
        <p className="text-sm md:text-center text-left text-muted-foreground">
          ClickWork is a vibrant online community platform that empowers people to
          apply, <br className="hidden md:block" />
          find and work smart
        </p>
      </BackdropGradient>
