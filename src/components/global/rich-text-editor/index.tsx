...
const BlockTextEditor = ({
  ...
  const [charachters, setSetCharacters] = useState<number | undefined>(
    ...
    <div>
      ...
      {htmlContent && !onEdit && inLine ? (
        ...
        <EditorRoot>
          ...
          >
            <EditorCommand className="z-50 h-auto max-h[330px] w-72 overflow-y-auto rounded-md border border-muted bg-background px-1 py-2 shadow-md transtion-all">
              ...
              {suggestionItems.map((item: any) => (
                <EditorCommandItem
                  ...
                  key={item.title}
                >
                  <div className="flex h-10 w-10 itesm-center justify-center rounded-md border border-muted bg-background">
                    {item.icon}
                  </div>
                  <div>
              ...
              <div className="flex justify-between py-2">
                <p
                  className={cn(
                    "text-xs",
                    charachters &&
                      (charachters < min || charachters > max) &&
                      "text-red-500",
                  )}
                >
                  {charachters || 0} / {max}
